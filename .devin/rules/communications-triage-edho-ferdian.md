...
> **Truncated for Windsurf's 12,000-character workspace rule limit.** Read the full skill at `skills/communications-triage-edho-ferdian/SKILL.md` for complete instructions.
