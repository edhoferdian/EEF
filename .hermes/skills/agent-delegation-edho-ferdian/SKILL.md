...
delegate_task(
    ...
    context=(
        ...
        "## Loading the wrapped skill\n"
        "\n"
        "Your instructions live in the `code-quality-tooling-edho-ferdian` skill, not in this file. Load\n"
        "it through your harness's own skill mechanism first. If you have to\n"
        "open a file yourself, it is `<skill-name>/SKILL.md` (with `references/`\n"
        "beside it) inside the skills directory this ecosystem was installed into —\n"
        "go there directly. Other skills mentioned as `other-skill/...` are siblings\n"
...
delegate_task(
    ...
    context=(
        ...
        "## Loading the wrapped skill\n"
        "\n"
        "Your instructions live in the `code-simplification-edho-ferdian` skill, not in this file. Load\n"
        "it through your harness's own skill mechanism first. If you have to\n"
        "open a file yourself, it is `<skill-name>/SKILL.md` (with `references/`\n"
        "beside it) inside the skills directory this ecosystem was installed into —\n"
        "go there directly. Other skills mentioned as `other-skill/...` are siblings\n"
...
delegate_task(
    ...
    context=(
        ...
        "## Loading the wrapped skill\n"
        "\n"
        "Your instructions live in the `config-hygiene-edho-ferdian` skill, not in this file. Load\n"
        "it through your harness's own skill mechanism first. If you have to\n"
        "open a file yourself, it is `<skill-name>/SKILL.md` (with `references/`\n"
        "beside it) inside the skills directory this ecosystem was installed into —\n"
        "go there directly. Other skills mentioned as `other-skill/...` are siblings\n"
...
delegate_task(
    ...
    context=(
        ...
        "## Loading the wrapped skill\n"
        "\n"
        "Your instructions live in the `container-ops-edho-ferdian` skill, not in this file. Load\n"
        "it through your harness's own skill mechanism first. If you have to\n"
        "open a file yourself, it is `<skill-name>/SKILL.md` (with `references/`\n"
        "beside it) inside the skills directory this ecosystem was installed into —\n"
        "go there directly. Other skills mentioned as `other-skill/...` are siblings\n"
...
delegate_task(
    ...
    context=(
        ...
        "## Loading the wrapped skill\n"
        "\n"
        "Your instructions live in the `desktop-e2e-edho-ferdian` skill, not in this file. Load\n"
        "it through your harness's own skill mechanism first. If you have to\n"
        "open a file yourself, it is `<skill-name>/SKILL.md` (with `references/`\n"
        "beside it) inside the skills directory this ecosystem was installed into —\n"
        "go there directly. Other skills mentioned as `other-skill/...` are siblings\n"
...
delegate_task(
    ...
    context=(
        ...
        "## Loading the wrapped skill\n"
        "\n"
        "Your instructions live in the `e2e-testing-edho-ferdian` skill, not in this file. Load\n"
        "it through your harness's own skill mechanism first. If you have to\n"
        "open a file yourself, it is `<skill-name>/SKILL.md` (with `references/`\n"
        "beside it) inside the skills directory this ecosystem was installed into —\n"
        "go there directly. Other skills mentioned as `other-skill/...` are siblings\n"
...
delegate_task(
    ...
    context=(
        ...
        "## Loading the wrapped skill\n"
        "\n"
        "Your instructions live in the `git-and-release-ops-edho-ferdian` skill, not in this file. Load\n"
        "it through your harness's own skill mechanism first. If you have to\n"
        "open a file yourself, it is `<skill-name>/SKILL.md` (with `references/`\n"
        "beside it) inside the skills directory this ecosystem was installed into —\n"
        "go there directly. Other skills mentioned as `other-skill/...` are siblings\n"
