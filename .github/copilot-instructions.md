...
| `code-quality-tooling-edho-ferdian` | Set up and configure the automated code-quality gate around a project — Biome or ESLint+Prettier, Husky Git hooks (pre-commit/pre-push),… | `skills/code-quality-tooling-edho-ferdian/SKILL.md` |
...
| `code-simplification-edho-ferdian` | Behavior-preserving refactoring workflow that actively rewrites code for clarity — extracting overlong functions, flattening deep nesting,… | `skills/code-simplification-edho-ferdian/SKILL.md` |
...
| `dev-kickoff-edho-ferdian` | Kickoff and execute a development project from ANY specification or planning documents (PRD, SRS, WBS, tech spec, RFC, ADRs, and more — see… | `skills/dev-kickoff-edho-ferdian/SKILL.md` |
...
| `frontend-engineering-edho-ferdian` | Authoring and configuration guidance for building React/Next.js frontend applications well from the start — component composition,… | `skills/frontend-engineering-edho-ferdian/SKILL.md` |
...
| `security-review-edho-ferdian` | Single source of truth for security review criteria across the Edho Ferdian ecosystem — general OWASP-style checklist (SEC-01..19), plus… | `skills/security-review-edho-ferdian/SKILL.md` |
